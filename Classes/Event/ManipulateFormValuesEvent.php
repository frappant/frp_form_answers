...
{
    /**
     * @var array<string, array{value:mixed, conf: array{label:mixed, inputType:string}}>
     */
    ...
    /**
     * @param array<string, array{value:mixed, conf: array{label:mixed, inputType:string}}> $addedValues
     */
