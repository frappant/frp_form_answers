...
module.tx_frpformanswers_web_frpformanswersformansers {
  persistence {
    storagePid = {$module.tx_frpformanswers_formansers.persistence.storagePid}
  }
  view {
    templateRootPaths.0 = EXT:frp_form_answers/Resources/Private/Backend/Templates/
    templateRootPaths.1 = {$module.tx_frpformanswers_formansers.view.templateRootPath}
    partialRootPaths.0 = EXT:frp_form_answers/Resources/Private/Backend/Partials/
    partialRootPaths.1 = {$module.tx_frpformanswers_formansers.view.partialRootPath}
    layoutRootPaths.0 = EXT:frp_form_answers/Resources/Private/Backend/Layouts/
    layoutRootPaths.1 = {$module.tx_frpformanswers_formansers.view.layoutRootPath}
  }
}
